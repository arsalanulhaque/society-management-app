        ...
        <>
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Select onValueChange={(val) => {
                                ...
                                setFilterMenuList(selected ?? null);
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select a menu to view or edit its actions.
              </CardDescription>
            </CardHeader>
          </Card>
                  ...
                  <div className="rounded-md border">
                    ...
                    {filteredMenuActions?.map(item => (
                      <div key={item.MenuActionID} className="grid grid-cols-6 p-4 border-t items-center text-sm">
                        ...
                        <div className="col-span-2">{item?.ActionName}</div>
                        <div className="col-span-2 flex justify-end gap-2 ">
                          <IconTooltip tooltip="Edit">
                            {hasPermission(fullUrl, 'CanUpdate') &&
                              (<Button variant="outline" size="sm" onClick={() => handleEditMenuActionMap(item)} 
                          ...
                          <IconTooltip tooltip="Delete">
                            {hasPermission(fullUrl, 'CanDelete') && (
                              ...
                              variant="outline" 
                              size="sm" 
                              onClick={() => handleDeleteMenuActionMap(item.MenuActionID)} 
